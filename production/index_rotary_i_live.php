...
//mqtt broker 
    ...
    var option = {
        ...
        onSuccess: function () {
            ...
            client_speed.subscribe('mas/speed', {qos: 0});
...
//mqtt broker 
	var client_temp = new Paho.MQTT.Client(MQTTbroker, MQTTport,
				"myclientid_" + parseInt(Math.random() * 100, 10));
	

    client_temp.onConnectionLost = function (responseObject) {
        alert("connection lost: " + responseObject.errorMessage);
        tempGauge.setLedColor(steelseries.LedColor.RED_LED); //change status LED to RED on broker disconnection 

    };

    client_temp.onMessageArrived = function (message) {
    ...
    var optio = {
        ...
        onSuccess: function () {
            // alert("Connected");
            // Connection succeeded; subscribe to our topic
            client_temp.subscribe('mas/temp', {qos: 0});
    ...
    function temp_gauge() {
        ...
        tempGauge = new steelseries.Radial('gaugeCanvas_temp', {
            gaugeType: steelseries.GaugeType.TYPE4,
            minValue:0,
            maxValue:250,
            size: 300,
...
function on_off_status() {
 ...
 <!-- /counter --> 
  ...
  <body class="nav-md" onload="temp_graph(); speed_gauge(); date_time('date_time'); temp_gauge(); count_print();">
    <div class="container body">
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a class="site_title"><i class="fa fa-adn"></i> <span>Rotary I Machine</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              ...
              &nbsp;
                ...
                <li><a href="index_rotary_i_live.php"><i class="fa fa-dashboard"></i> Rotary I Live Status <span class="fa fa-chevron-down"></span></a>
                   <ul class="nav child_menu">
                      
                   </ul>
                 </li>
                  <li><a href="index_rotary_i.php"><i class="fa fa-dashboard"></i> Rotary I Status <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      
                    </ul>
                  </li>
                  <li><a href="index_rotary_i_dryer.php"><i class="fa fa-dashboard"></i> Dryer Status <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
