            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              ...
              &nbsp;
                ...
                <li><a href="index_rotary_ii_live.php"><i class="fa fa-dashboard"></i> Rotary II Live Status <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li><a href="index_rotary_ii.php"><i class="fa fa-dashboard"></i> Rotary II Status <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      
                    </ul>
                  </li>
                  <li><a href="index_rotary_ii_dryer.php"><i class="fa fa-dashboard"></i> Dryer Status <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
