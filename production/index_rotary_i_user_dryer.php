...
session_start();
    ...
    if(isset($_SESSION['id'])) {
      ...
      //  echo "Welcome, {$username}!";
        ...
        header('Location: index_flatbed_user.php');
       // die();
    }
          ...
          <div class="left_col scroll-view">
            ...
            <div class="profile">
              <div class="profile_pic">
                <img src="images/img_user1.jpg" alt="..." class="img-circle profile_img">
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              ...
              &nbsp;
                ...
                <ul class="nav side-menu">
                  <li><a href="index_rotary_i_user.php"><i class="fa fa-dashboard"></i> Rotary I Status <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      
                      
                    </ul>
                  </li>
                  <li><a href="index_rotary_i_user_dryer.php"><i class="fa fa-dashboard"></i> Dryer Status <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                  ...
                  <li>
                  	<a href="index_back_user.php"><i class="fa fa-arrow-left"></i> Back to Machines List </a>
                  </li>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img_user1.jpg" alt="">
